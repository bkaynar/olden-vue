        ...
        <q-card class="register-modal">
            ...
            <q-card-section class="modal-body">
                <div class="form-title">
                    <h3>Kayıt Ol</h3>
                    <p>Hemen üye olun ve büyük kazançların tadını çıkarın!</p>
                </div>
                ...
                <div v-if="currentStep === 1" class="step-content">
                    <q-form @submit="nextStep" class="register-form">
                        <div class="form-row">
                            <div class="form-group">
                                <q-input v-model="registerForm.firstName" label="Ad" outlined dense class="custom-input"
                            ...
                            <div class="form-group">
                                <q-input v-model="registerForm.lastName" label="Soyad" outlined dense
                                    class="custom-input" :rules="[val => !!val || 'Soyad gerekli']">
                                    <template v-slot:prepend>
                                        <q-icon name="person_outline" color="green" />
                                    </template>
                                </q-input>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <q-input v-model="registerForm.username" label="Kullanıcı Adı" outlined dense
                                class="custom-input"
                                :rules="[val => !!val || 'Kullanıcı adı gerekli', val => val.length >= 3 || 'En az 3 karakter olmalı']">
                                <template v-slot:prepend>
                        ...
                        <div class="form-group">
                            <q-input v-model="registerForm.email" label="E-posta" type="email" outlined dense
                                class="custom-input" :rules="[val => !!val || 'E-posta gerekli', isValidEmail]">
                                <template v-slot:prepend>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <q-input v-model="registerForm.password" :type="showPassword ? 'text' : 'password'"
                                    label="Şifre" outlined dense class="custom-input"
                            ...
                            <div class="form-group">
                                <q-input v-model="registerForm.confirmPassword"
                                    :type="showConfirmPassword ? 'text' : 'password'" label="Şifre Tekrar" outlined
                                    dense class="custom-input"
                        ...
                        <div class="form-group">
                            <q-select v-model="registerForm.currency" :options="currencyOptions" label="Para Birimi"
                                outlined dense class="custom-input" emit-value map-options
                ...
                <div v-if="currentStep === 2" class="step-content">
                    <q-form @submit="handleRegister" class="register-form">
                        <div class="form-group">
                            <q-input v-model="registerForm.phone" label="Telefon" outlined dense class="custom-input"
                                mask="+90 (###) ### ## ##" :rules="[val => !!val || 'Telefon gerekli']">
                                <template v-slot:prepend>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <q-input v-model="registerForm.postalCode" label="Posta Kodu" outlined dense
                                    class="custom-input" mask="#####" :rules="[val => !!val || 'Posta kodu gerekli']">
                                    <template v-slot:prepend>
                            ...
                            <div class="form-group">
                                <q-select v-model="registerForm.city" :options="cityOptions" label="İl" outlined dense
                                    class="custom-input" emit-value map-options
                                    :rules="[val => !!val || 'İl seçimi gerekli']" @update:model-value="onCityChange">
                                    <template v-slot:prepend>
                        ...
                        <div class="form-group">
                            <q-select v-model="registerForm.district" :options="districtOptions" label="İlçe" outlined
                                dense class="custom-input" emit-value map-options
                                :rules="[val => !!val || 'İlçe seçimi gerekli']" :disable="!registerForm.city">
                                <template v-slot:prepend>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <q-input v-model="registerForm.birthDate" label="Doğum Tarihi" outlined dense
                                    class="custom-input" mask="##/##/####" placeholder="GG/AA/YYYY"
                            ...
                            <div class="form-group">
                                <q-input v-model="registerForm.tcNo" label="TC Kimlik No" outlined dense
                        ...
                        <div class="form-options">
                            <q-checkbox v-model="registerForm.acceptTerms" color="green" class="terms-checkbox">
                                <span class="terms-text">
                                    <a href="#" @click.prevent="openTerms" class="terms-link">Kullanım Şartları</a>'nı
                                    ve
                                    <a href="#" @click.prevent="openPrivacy" class="terms-link">Gizlilik
                                        Politikası</a>'nı kabul
                                    ediyorum
                                </span>
                            </q-checkbox>

                            <q-checkbox v-model="registerForm.acceptMarketing" color="green" class="marketing-checkbox"
